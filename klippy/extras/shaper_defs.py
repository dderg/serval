...
INPUT_SMOOTHERS = [
    ...
    InputSmootherCfg("smooth_mzv", get_mzv_smoother, min_freq=23.0),
    InputSmootherCfg("smooth_ei", get_ei_smoother, min_freq=23.0),
    InputSmootherCfg("smooth_2hump_ei", get_2hump_ei_smoother, min_freq=23.0),
    InputSmootherCfg("smooth_zvd_ei", get_zvd_ei_smoother, min_freq=23.0),
