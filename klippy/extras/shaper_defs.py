...
INPUT_SMOOTHERS = [
    InputSmootherCfg("smooth_zv", get_zv_smoother, min_freq=21.0),
    InputSmootherCfg("smooth_mzv20", get_mzv20_smoother, min_freq=23.0),
    InputSmootherCfg("smooth_mzv16", get_mzv16_smoother, min_freq=23.0),
    InputSmootherCfg("smooth_2hump_ei", get_2hump_ei_smoother, min_freq=23.0),
    InputSmootherCfg("smooth_si", get_si_smoother, min_freq=23.0),
    InputSmootherCfg("smooth_nei", get_nei_smoother, min_freq=23.0),
    InputSmootherCfg("smooth_nsi", get_nsi_smoother, min_freq=23.0),
]
