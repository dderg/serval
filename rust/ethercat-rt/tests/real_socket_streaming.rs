...
use ethercat_rt::curves::AXIS_RING_CAPACITY;
use ethercat_rt::server::FrameServer;

/// The stub is single-drive; this test asserts its single-axis caps.
...
use mcu_protocol::messages::{MessageKind, PushPieces, PushPiecesResponse};
...
#[test]
fn mcu_serial_conn_and_frame_server_sustain_streaming_past_ring_depth() {
