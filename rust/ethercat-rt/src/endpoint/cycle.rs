...
pub(super) fn police_frame_timing(ctx: &mut EndpointCtx, lateness_ns: i64) {
    ...
    if reanchored {
        ...
        tracing::error!(
            ...
            dispatch_pump_ns = ctx.last_dispatch_pump_ns,
            dispatch_command = ctx.last_dispatch_command,
            dispatch_command_ns = ctx.last_dispatch_command_ns,
            dispatch_command_count = ctx.last_dispatch_command_count,
            response_count = ctx.last_response_metrics.count,
            response_total_ns = ctx.last_response_metrics.total_ns,
            response_max_ns = ctx.last_response_metrics.max_ns,
            response_pending_bytes = ctx.last_response_metrics.pending_bytes,
