/* @ts-self-types="./motion_playground.d.ts" */
 ...
 * @param {string} gcode_text
 * @param {string} config_json
 * @returns {string}
 */
export function plan(gcode_text, config_json) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(gcode_text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(config_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.plan(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @param {string} gcode_text
 * @param {string} config_json
 * @param {Function} on_partial
 * @returns {string}
 */
export function plan_streaming(gcode_text, config_json, on_partial) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(gcode_text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const ptr1 = passStringToWasm0(config_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.plan_streaming(ptr0, len0, ptr1, len1, on_partial);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./motion_playground_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('motion_playground_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
